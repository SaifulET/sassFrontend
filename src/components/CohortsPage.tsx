          ...
          <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => {
                  const csvContent = "Cohort,Size,Month 0,Month 1,Month 2\n" +
                    "Jan 2024,15,100%,90%,85%\n";
                  const blob = new Blob([csvContent], { type: "text/csv;charset=utf-8;" });
                  const url = URL.createObjectURL(blob);
                  const link = document.createElement("a");
                  link.href = url;
                  link.download = "cohorts_report.csv";
                  link.click();
              ...
              <div className="flex justify-end pt-2 gap-3 flex-none">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    link.setAttribute("download", "cohorts_report.csv");
