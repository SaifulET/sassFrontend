...
const tableRows = [
  { year: "2020", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
  { year: "2021", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
  { year: "2022", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
  { year: "2023", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
  { year: "2024", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
  { year: "2025", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
];
...
function LTVChart({
  ...
  const series = useMemo(() => {
    ...
    if (timeRange === "Yearly") {
      return [
        { month: "2020", value: 35000 },
        { month: "2021", value: 42000 },
        { month: "2022", value: 48000 },
        { month: "2023", value: 50000 },
        { month: "2024", value: 55000 },
        { month: "2025", value: 59000 },
      ];
    }
    // "2023-2025"
    return [
...
// ---- Page Component ----
export default function LTVPage({ setActiveTab }: { setActiveTab?: (tab: string) => void }) {
  ...
  const currentTableRows = useMemo(() => {
    if (timeRange === "Monthly") {
      return [
        { year: "Jan 2025", ltv: "€ 1,210", deltaAmt: "€ 40", deltaPct: "(2.5%)", arpa: "€ 205", churn: "(18%)" },
        { year: "Feb 2025", ltv: "€ 1,220", deltaAmt: "€ 41", deltaPct: "(2.6%)", arpa: "€ 206", churn: "(18%)" },
        { year: "Mar 2025", ltv: "€ 1,230", deltaAmt: "€ 42", deltaPct: "(2.7%)", arpa: "€ 207", churn: "(18.5%)" },
        { year: "Apr 2025", ltv: "€ 1,240", deltaAmt: "€ 43", deltaPct: "(2.8%)", arpa: "€ 208", churn: "(19%)" },
        { year: "May 2025", ltv: "€ 1,250", deltaAmt: "€ 45", deltaPct: "(3%)", arpa: "€ 210", churn: "(20%)" },
      ];
    }
    if (timeRange === "2023-2025") {
      return tableRows.filter((r) => ["2023", "2024", "2025"].includes(r.year));
    }
    return tableRows;
  }, [timeRange]);
    ...
    <div className="w-full min-w-0">
      <div className="flex w-full flex-col gap-5 text-left text-[#283442] animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <section className="relative w-full rounded-xl bg-white p-6 shadow-[0_4px_18px_rgba(17,31,56,0.06)]">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-wrap items-center gap-3">
                <h2 className="text-[16px] font-semibold leading-[22px] text-[#29343D]">
                  Salon's Customer Lifetime Value
                </h2>
              </div>
            </div>
          ...
          {/* The chart */}
          <div className="pb-4">
            <LTVChart timeRange={timeRange} chartMode={chartMode} setExportModalOpen={setExportModalOpen} />
          </div>

          {/* Stat Cards */}
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
            <StatCard title="Current Year LTV" value="€ 255" note={null} />
            <StatCard
              title="Previous Year LTV"
              value="€ 355"
              note={
                <span>
                  vs Previous Year <span className="text-[#FF6692]">(6%)</span>
                </span>
              }
            />
            <StatCard title="Average ARPA for the year" value="€ 463" note={null} />
            <StatCard title="Average churn rate for the year" value="€ 407,060" note={null} />
            <StatCard title="Best month in the year for LTV" value="€ 365" note="March" />
          </div>
        </section>
            ...
            <table className="min-w-[900px] w-full border-collapse text-left">
              <thead>
                <tr className="bg-[#F5F4FF]">
                  <th className="border-b border-r border-[#E0E6EB] px-5 py-4 text-[13px] font-bold text-[#29343D]">
                    {timeRange === "Monthly" ? "Month" : "Year"}
                  </th>
                  <th className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[13px] font-bold text-[#29343D]">LTV (€)</th>
                  <th className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[13px] font-bold text-[#29343D]">Δ vs Previous Year (€)</th>
                  <th className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[13px] font-bold text-[#29343D]">Δ vs Previous Year (%)</th>
                  <th className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[13px] font-bold text-[#29343D]">Average ARPA (€)</th>
                  <th className="border-b border-[#E0E6EB] px-5 py-4 text-center text-[13px] font-bold text-[#29343D]">Average Customer Churn Rate (%)</th>
                </tr>
              </thead>
              <tbody>
                {currentTableRows.map((row) => (
                  <tr key={row.year} className="odd:bg-white even:bg-[#FAFAFA]">
                    <td className="border-b border-r border-[#E0E6EB] px-5 py-4 text-[12px] font-bold text-[#29343D]">{row.year}</td>
                    <td className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[12px] text-[#29343D]">{row.ltv}</td>
                    <td className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[12px] text-[#29343D]">{row.deltaAmt}</td>
                    <td className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[12px] font-bold text-[#FF6692]">{row.deltaPct}</td>
                    <td className="border-b border-r border-[#E0E6EB] px-5 py-4 text-center text-[12px] text-[#29343D]">{row.arpa}</td>
                    <td className="border-b border-[#E0E6EB] px-5 py-4 text-center text-[12px] font-bold text-[#FF6692]">{row.churn}</td>
                  </tr>
                ))}
              </tbody>
            </table>
